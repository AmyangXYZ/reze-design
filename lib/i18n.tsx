...
const en = {
  ...
  account: {
    ...
    codeSentTo: (email: string) => `Enter the 6-digit code sent to ${email}.`,
    verifyCode: "Sign in",
    otherEmail: "Use a different email",
    sendAgain: "Send again",
    badCode: "That code is wrong or has expired.",
    sendFailed: "Couldn't send the email. Wait a minute and try again.",
    handle: "User name",
  ...
  profile: {
    ...
    joined: (month: string) => `Since ${month}`,
    scenesTitle: "Scenes",
    effectsTitle: "Effects",
    graphsTitle: "Shader graphs",
    gradesTitle: "Grades",
    mostViewed: "Most viewed",
    pinned: "Pinned",
    pin: "Pin to top",
    unpin: "Unpin",
    pinDone: "Pinned to your page",
    unpinDone: "Unpinned",
    watch: "Watch",
  ...
  share: {
    ...
    bundleTooBig: (size: string, limit: string) => `Assets are ${size} — the limit is ${limit}. Remove a model or use smaller textures.`,
  ...
  rail: {
    ...
    // The library is one ranked list, so the rail filters rather than shelves.
  ...
  stage: {
    title: "Stage",
    uploadStageFolder: "Upload stage folder (PMX / GLB)",
    uploadStageZip: "Upload stage zip",
    placement: "Placement",
    position: "Pos",
    rotation: "Rot",
    scale: "Scale",
  ...
  library: {
    ...
    // In use = worn by a group in this scene; deleting it would strand the look.
    deleteInUse: "In use by this scene",
    new: "New",
    visibility: "Visibility",
    visPublic: "Public",
    visPrivate: "Private",
    visLocked: "Already published. Scenes may be using it, so it cannot be made private again — delete it if you want it gone.",
  ...
  transport: {
    ...
    loopOn: "Loop on",
    loopOff: "Loop off",
    eyesOn: "Eyes on camera",
    eyesOff: "Eyes as animated",
  ...
  lab: {
    ...
    tabs: {
      stage: "Stage",
      /** The Objects row's two: cards and props. */
      plane: "Planes",
      prop: "Props",
      ground: "Ground",
    ...
    timeline: {
      ...
      throwTo: "To",
      throwIt: "Throw",
      throwStyles: { pass: "Pass", toss: "Toss", lob: "Lob" },
    ...
    ctl: {
      ...
      propsN: (n: number) => `${n} props`,
      /** What a prop hangs from. */
      attachTo: "Attach to",
      bone: "Bone",
      none: "None",
      strength: "Strength",
    ...
    cmd: {
      ...
      eyesOn: "Turn on eyes on camera",
      eyesOff: "Turn off eyes on camera",
  ...
  socket: {
    ...
    reflection_lod: "Reflection Blur (Unity)",
    unity_direct: "Light Highlights (Unity)",
    sheen: "Sheen",
...
const zh: Dictionary = {
  ...
  account: {
    ...
    emailPlaceholder: "you@example.com",
    sendCode: "发送邮箱验证码",
    codeSentTo: (email: string) => `请输入发送到 ${email} 的 6 位验证码。`,
    verifyCode: "登录",
    otherEmail: "换一个邮箱",
    sendAgain: "重新发送",
    badCode: "验证码错误或已过期。",
    sendFailed: "邮件发送失败，请稍等一分钟再试。",
    handle: "用户名",
    handleTitle: "选择你的用户名",
  ...
  share: {
    ...
    failedUpload: "上传失败",
    failedPublish: "发布失败",
    bundleTooBig: (size: string, limit: string) => `资源共 ${size}，上限为 ${limit}。请减少模型或使用更小的贴图。`,
    signIn: "登录后可发布场景",
  ...
  stage: {
    title: "舞台",
    uploadStageFolder: "上传舞台文件夹（PMX / GLB）",
    uploadStageZip: "上传舞台压缩包",
    placement: "位置",
    position: "位置",
    rotation: "旋转",
    scale: "缩放",
  ...
  library: {
    ...
    visPublic: "公开",
    visPrivate: "私有",
    visLocked: "已经发布过。可能有场景正在使用，因此无法再改为私有——如果要移除请删除它。",
  ...
  lab: {
    ...
    timeline: {
      ...
      throwTo: "抛给",
      throwIt: "抛出",
      throwStyles: { pass: "传", toss: "抛", lob: "高抛" },
      throwPosition: "坐标",
      offset: "偏移",
  ...
  socket: {
    ...
    specular: "高光",
    spec_clamp: "高光钳制",
    reflection_lod: "反射模糊（Unity）",
    unity_direct: "灯光高光（Unity）",
    sheen: "光泽",
    sheen_tint: "光泽染色",
  },
}
