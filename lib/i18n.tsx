...
const ja: Dictionary = {
  ...
  share: {
    ...
    unpublishedTitle: "先にライブラリへ公開してください",
    unpublishedBlurb: "シーンはライブラリにあるものだけで公開できます。見た人がそこで使われているものを見つけ、作者を辿り、再利用できるようにするためです。",
    unpublishedKind: { graph: "シェーダー", grade: "カラーグレード", effect: "エフェクト" },
  },
  editor: {
  ...
  gradeLibrary: {
    ...
    publish: "公開",
    revert: "プリセットに戻す",
    exportJson: "カラーグレードを JSON で書き出す",
    importJson: "カラーグレードを JSON から読み込む",
    importNotJson: "このファイルは JSON ではありません。",
    importNotGrade: "この JSON はカラーグレードではありません。",
  ...
  rail: {
    ...
    community: "コミュニティ",
    builtin: "組み込み",
    communityEmpty: "まだ誰も公開していません。最初の一人になれます。",
    yours: "自分の",
    liked: "いいね",
  ...
  assets: {
    ...
    music: "音楽",
    or: "または",
    uploadModelFolder: "モデル PMX フォルダをアップロード",
    uploadModelZip: "モデル PMX ZIP をアップロード",
  ...
  stage: {
    title: "ステージ",
    uploadStageFolder: "ステージ PMX フォルダをアップロード",
    uploadStageZip: "ステージ PMX ZIP をアップロード",
    placement: "配置",
    position: "位置",
    rotation: "回転",
    scale: "スケール",
    switches: "スイッチ",
    noMorphs: "このステージにスイッチはありません。",
    reset: "リセット",
    groundOff: "地面はオフです — ステージが自前の床を持っています。",
  },
  render: {
    output: "出力",
    export: "書き出し",
    ...
    done: (file: string) => (file ? `動画を保存しました — ${file}` : "動画をダウンロードしました。"),
    failed: (message: string) => `書き出しに失敗：${message}`,
    encoderUnsupported: "このブラウザではこの設定で動画をエンコードできません。Chrome をお試しください。",
  ...
  library: {
    ...
    deleteInUse: "このシーンで使用中",
    clearLocal: "すべて削除",
    clearLocalConfirm: (n: number) => `${n} 件のローカル下書きを削除しますか？この端末にのみ存在し、未公開の内容は復元できません。`,
    clearLocalKept: (n: number) => ` このシーンで使用中の ${n} 件は残ります。`,
    clearLocalNone: "ここの下書きはすべてこのシーンで使用中です。",
    ...
    nameTaken: "その名前は使われています。別の名前を選んでください。",
    nameTakenBy: (name: string) => `「${name}」は既に存在します。別の名前を選んでください。`,
  ...
  graph: {
    ...
    exportJson: "ノードグラフを JSON で書き出す",
    importJson: "ノードグラフを JSON から読み込む",
    importNotJson: "このファイルは JSON ではありません。",
    importNotGraph: "この JSON はシェーダーグラフではありません。",
