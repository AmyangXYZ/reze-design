...
const en = {
  ...
  share: {
    ...
    creditsWhy: "Publishing shares the model, motion and music files — list everyone you borrowed from.",
...
const zh: Dictionary = {
  ...
  share: {
    ...
    creditsWhy: "发布会一并分享模型、动作与音乐文件，请写明所有借物出处。",
...
const ja: Dictionary = {
  ...
  share: {
    ...
    creditsWhy: "公開するとモデル・モーション・音楽のファイルも共有されます。お借りしたものをすべて明記してください。",
