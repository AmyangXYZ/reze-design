...
const en = {
  ...
  scene: {
    ...
    gradePresets: { neutral: "Neutral", golden: "Divine", sakura: "Sakura", moonlit: "Moonlit", cyberpunk: "Cyberpunk", bloody: "Bloody" },
    ground: "Ground",
...
const zh: Dictionary = {
  ...
  scene: {
    ...
    contrast: "对比度",
    saturation: "饱和度",
    gradePresets: { neutral: "中性", golden: "神圣", sakura: "樱色", moonlit: "月光", cyberpunk: "赛博朋克", bloody: "血色" },
    ground: "地面",
    gridLines: "网格线",
    resetDefaults: "恢复默认",
    effects: "特效",
...
const ja: Dictionary = {
  ...
  scene: {
    ...
    contrast: "コントラスト",
    saturation: "彩度",
    gradePresets: { neutral: "ニュートラル", golden: "神聖", sakura: "桜", moonlit: "月明かり", cyberpunk: "サイバー", bloody: "ブラッディ" },
    ground: "地面",
    gridLines: "グリッド線",
