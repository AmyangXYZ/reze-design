...
const en = {
  ...
  analysis: {
    ...
    sources: { all: "Everything", scenes: "Published scenes", exports: "Exports" },
    exports: "Exports",
    exportsNote: "videos finished",
    scenesTile: "Scenes",
    scenesNote: "published here",
    renderOnly: "Aspect, resolution and style come from exports — a published scene records no render size and no look pack.",
    models: "Models",
...
const zh: Dictionary = {
  ...
  analysis: {
    title: "大家都在渲染什么",
    intro: "来自打开了「分享导出统计」的用户。是已完成视频的样本，而非全量——任何一行都看不出是谁导出的。",
    sources: { all: "全部", scenes: "已发布场景", exports: "导出" },
    exports: "导出",
    exportsNote: "个已完成视频",
    scenesTile: "场景",
    scenesNote: "已在此发布",
    renderOnly: "画面比例、分辨率与风格来自导出——已发布的场景不记录渲染尺寸，也不记录渲染风格。",
    models: "模型",
    modelsNote: "去重，含未具名的",
    presets: "预设",
    presetsNote: "进入了成片",
