...
const en = {
  ...
  share: {
    ...
    title: "Publish scene",
    credits: "Credits (借物表)",
    creditsHint: "Model: 苍鹭·托特 by …\nMotion: … by …\nMusic: … by …",
    creditsWhy: "A shared scene redistributes these files. Credit their authors as you would in a video description.",
    blurb: "Uploads the scene's assets and publishes the whole look under a permanent link.",
    packing: "Packing assets…",
    uploading: "Uploading assets…",
    publishing: "Publishing…",
    done: "Published",
    viewerSoon: "The viewer page is on its way — the link will go live with it.",
    failed: "Publish failed — try again.",
...
const zh: Dictionary = {
  ...
  share: {
    ...
    title: "发布场景",
    credits: "借物表",
    creditsHint: "模型：苍鹭·托特 by …\n动作：… by …\n音乐：… by …",
    creditsWhy: "分享场景会一并转发这些文件，请像视频简介一样标注作者。",
    blurb: "上传场景资源，并以永久链接发布整个作品。",
    packing: "打包资源中…",
    uploading: "上传资源中…",
    publishing: "发布中…",
    done: "已发布",
    viewerSoon: "查看页面即将上线，届时链接生效。",
    failed: "发布失败，请重试。",
    signIn: "登录后可发布场景",
...
const ja: Dictionary = {
  ...
  share: {
    ...
    title: "シーンを公開",
    credits: "お借りしたもの",
    creditsHint: "モデル：苍鹭·托特 by …\nモーション：… by …\n音楽：… by …",
    creditsWhy: "共有シーンはこれらのファイルを再配布します。動画概要欄と同じように作者を明記してください。",
    blurb: "シーンのアセットをアップロードし、固定リンクで作品全体を公開します。",
    packing: "アセットを梱包中…",
    uploading: "アップロード中…",
    publishing: "公開中…",
    done: "公開しました",
    viewerSoon: "ビューアページは準備中 — 公開と同時にリンクが有効になります。",
    failed: "公開に失敗しました。もう一度お試しください。",
