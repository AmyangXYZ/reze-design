...
const en = {
  ...
  scene: {
    ...
    gradePresets: { neutral: "Neutral", filmic: "Filmic", golden: "Golden", sakura: "Sakura", moonlit: "Moonlit", cyberpunk: "Cyberpunk", ink: "Ink" },
    ground: "Ground",
...
const zh: Dictionary = {
  ...
  scene: {
    ...
    contrast: "对比度",
    saturation: "饱和度",
    gradePresets: { neutral: "中性", filmic: "胶片感", golden: "暖阳", sakura: "樱色", moonlit: "月光", cyberpunk: "赛博朋克", ink: "墨线" },
    ground: "地面",
    gridLines: "网格线",
    resetDefaults: "恢复默认",
    effects: "特效",
...
const ja: Dictionary = {
  ...
  scene: {
    ...
    contrast: "コントラスト",
    saturation: "彩度",
    gradePresets: { neutral: "ニュートラル", filmic: "フィルミック", golden: "黄金", sakura: "桜", moonlit: "月明かり", cyberpunk: "サイバー", ink: "墨" },
    ground: "地面",
    gridLines: "グリッド線",
