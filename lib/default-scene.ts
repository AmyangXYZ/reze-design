...
const DEMO_SCENE_DOC: SceneDoc = {
  ...
  settings: {
    ...
    ground: { enabled: true, color: "#c800de", size: 160, opacity: 0.48, shadow: true, grid: "#fafaf9", gridEnabled: true, fade: { start: 0.2, end: 1 } },
...
export const EMPTY_SCENE_DOC: SceneDoc = {
  ...
  settings: {
    ...
    grade: { preset: "Neutral", intensity: 1 },
    ground: { enabled: true, color: "#3a3a3d", size: 160, opacity: 0.42, shadow: true, grid: "#fafaf9", gridEnabled: true, fade: { start: 0.2, end: 1 } },
    physics: DEFAULT_PHYSICS,
    eyes: DEFAULT_EYES,
  },
}
